...
![The second-order factor model.](figures/day3-twoFactor.png){width=800px}
...
Commands in Mplus must not exceed 90 characters per line. So if your path is quite long, don’t forget to break up your command (before the 90$^{th}$ character) and continue on a second (or third, etc.) line. See the example above. 
